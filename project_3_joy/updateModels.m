...
%-------------------------------------------------------------------------------
   %[ColorModels, local_mask] = initColorModels(CurrentFrame, warpedMask, warpedMaskOutline, LocalWindows, WindowWidth);
   
   ShapeConfidences = initShapeConfidences(LocalWindows, ColorModels, warpedMask, WindowWidth, SigmaMin, SigmaMax, A, fcutoff, R); 

function [] = showColorConfidences(IMG,MaskOutline,ColorConfidences,LocalWindows,Width,prev)
...
for i = 1:length(LocalWindows)
    ...
    LocalNum = LocalWeight .* repmat(ColorConfidences{i}.Confidence,[Width Width]);
...
%saveas(gcf,sprintf('../colormodel/%d.jpg',prev));
end

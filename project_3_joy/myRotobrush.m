...
F = getframe(gcf);
[I,~] = frame2im(F);
showColorConfidences(images{1},mask_outline,ColorModels,LocalWindows,WindowWidth,0);
...
%for prev=1:(length(files)-1)
    ...
    showColorConfidences(images{1},mask_outline,ColorModels,LocalWindows,WindowWidth,prev);
